...
namespace Crownwood.Magic.Controls
{
	...
	public class TabControl : Panel
	{
		...
		public virtual Rectangle GetTabRect(int i)
		{
			try
			{
			...
			{
				MessageBox.Show("TabControl.cs Error!", "Error!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
				Rectangle rect1 = (Rectangle)_tabRects[i];
				return rect1;
			}
		}
